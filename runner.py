...
def create_command(param):
    ...
    if "tc" in param.keys():
        result = result + " --test-case \"" + param["tc"] + "\""
    if "constraints" in param.keys():
        result = result + " " + param["constraints"]
...
for file in dir_list:
    ...
    output = subprocess.Popen(["~/epg/queue_run2.py", create_command(conf)],
